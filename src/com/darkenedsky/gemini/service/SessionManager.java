...
public class SessionManager<TPlay extends Player> implements ActionList {
	 ...
	 * @param eFac Email factory
	 */
	public SessionManager(Class<TPlay> pClass, JDBCConnection jDBC, Message sets, WinLossRecordManager rec, EmailFactory eFac) { 
		playerClass = pClass;
		jdbc = jDBC;
		recordManager = rec;
		settings = sets;
	...
	public Message createAccount(Message e) throws Exception { 
		...
		try { 
			...
			// setting this up is optional so just log that there was no template if there wasn't
			try {
				HashMap<String, String> fields = new HashMap<String, String>();
				emailFactory.sendEmail(e.getString("email"), "createaccount", lang, fields);
			}
	...
	public void forgotPassRequest(Message e) throws Exception { 
		...
		try { 
			...
			emailFactory.sendEmail(e.getString("email"), "forgotpassrequest", e.getString("language"), fields);
